...
class PagerAdapter(private val listener: PagerListener) : RecyclerView.Adapter<RecyclerView.ViewHolder>() { // RecyclerView.Adapter принимает все виды ViewHolder
    ...
    override fun getItemViewType(position: Int): Int {  // метод для определения какою верстку нужно подключать
